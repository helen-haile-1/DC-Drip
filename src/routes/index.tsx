...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* HERO */}
      <section id="top" className="relative pt-32 pb-24 md:pt-44 md:pb-32 bg-aurora">
        <div className="absolute inset-0 -z-10 opacity-40">
          <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-aqua/40 blur-3xl animate-float" />
          <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-gold/30 blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
        </div>
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-background/40 backdrop-blur border border-border text-xs font-semibold tracking-widest uppercase text-aqua">
              <span className="w-1.5 h-1.5 rounded-full bg-aqua animate-pulse" /> Washington DC · Maryland · Virginia
            </span>
            <h1 className="mt-6 font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light leading-[0.95]">
              Hydrate. <span className="italic font-normal text-gradient">Heal.</span><br />
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a href="https://dc-drip.janeapp.com/" className="group relative inline-flex items-center gap-3 px-7 py-4 rounded-full bg-hero-gradient text-primary-foreground font-semibold shadow-glow hover:scale-[1.03] transition">
                Book Your Session
            ...
            <div className="mt-12 grid grid-cols-4 gap-4 max-w-lg">
              {stats.map(s => (
                <div key={s.l}>
                  <div className="font-display text-3xl md:text-4xl font-semibold text-gradient">{s.n}</div>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-hero-gradient rounded-[2rem] blur-2xl opacity-50" />
<img src={heroIv} alt="Professional mixed-race woman receiving IV vitamin therapy while working in a luxury wellness lounge" width={1920} height={1280} className="relative rounded-[2rem] shadow-glow object-cover w-full h-[520px] md:h-[640px]" />
            <div className="absolute bottom-6 left-6 right-6 flex items-center gap-3 px-5 py-4 rounded-2xl bg-background/80 backdrop-blur-xl border border-border">
              <div className="w-10 h-10 rounded-full bg-gold/20 flex items-center justify-center text-xl">⚕️</div>
              <div>
                <div className="text-sm font-semibold">Medically supervised</div>
                <div className="text-xs text-muted-foreground">Board-certified nurses, pharmaceutical-grade blends</div>
              </div>
            </div>
          </div>
        </div>
