...
Public website domain: `https://www.dc-drip.com`
Public mobile/app domain: `https://dc-drip.app`
Admin tracking page: `https://dc-drip.com/admin/html`
Default Firebase hosting target: `https://dc-drip.web.app`
...
- DNS for `www.dc-drip.com` should point to the Firebase Hosting target with `CNAME www dc-drip.web.app`; visitors still see `www.dc-drip.com`.
